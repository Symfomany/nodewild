...
var paypal = Paypal.init('julie_api1.meetserious.com', 'TM4E2TPP5Q4XFVXD', 'All4UJDmyWTWhg1CD6xRXR5afv3FAChTf-fg6nz4kiaVZAoSrKIhY-eb', 'http://localhost:8080/pages', 'http://localhost:8080/pages', true);
...
module.exports = function (app, passport) {
	...
	app.get('/paypal', function (req, res) {
		...
		//detail
		paypal.detail(totaljs.controller, function (err, data, invoiceNumber, price) {
